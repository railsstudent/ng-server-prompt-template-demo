...
fetch(url)
  ...
  .then((data) => {
    ...
    const sortedCities = pairs.sort((a, b) => a.city.localeCompare(b.city));
    const result = {
      results: sortedCities,
    };
...
// fs.writeFileSync(targetPath, JSON.stringify(result, null, 2), 'utf-8');
// console.log('✅ ' + pairs.length + ' cities with population greater than ' + minPopulation + ' have been processed.');
// console.log('✅ Firebase configuration generated successfully at ' + targetPath);
